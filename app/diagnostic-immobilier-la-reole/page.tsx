...
export const metadata: Metadata = {
  title: "Diagnostic immobilier La Réole | ENEOS HABITAT — Gironde",
  description: "ENEOS HABITAT intervient à La Réole pour tous vos diagnostics immobiliers obligatoires. DPE, Amiante, Plomb, Électricité, Gaz. Intervention sous 48h. Devis gratuit en ligne.",
  alternates: {
    canonical: "https://www.eneoshabitat.fr/diagnostic-immobilier-la-reole"
  }
}

export default function LaReolePage() {
  return (
    <CityPageTemplate
      cityName="La Réole"
      citySlug="la-reole"
      metaDescription="ENEOS HABITAT intervient à La Réole pour tous vos diagnostics immobiliers obligatoires."
    />
  )
}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white mb-6">
              ...
              <span className="text-sm font-medium">DIAGNOSTIC À LA RÉOLE</span>
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Diagnostic immobilier à <span className="text-[#2d8a5e]">La Réole</span>
            </h1>
            <p className="text-xl text-white/80 mb-8">
              ENEOS HABITAT réalise tous vos diagnostics immobiliers à La Réole. Expertise, rapidité et certifications garanties pour vos transactions.
            </p>
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold mb-8 text-gray-900">Zone d'intervention à La Réole</h2>
          
          <p className="text-gray-700 mb-6 leading-relaxed">
            ENEOS HABITAT intervient à La Réole et dans les communes alentour : Monségur, Sauveterre-de-Guyenne, Saint-Foy-la-Grande, Eymet et tous les secteurs entre Bordeaux et Périgueux.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Disponibilité sous 48h pour tous vos diagnostics immobiliers à La Réole.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Diagnostics immobiliers à La Réole au meilleur prix, sans frais cachés.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold mb-8 text-gray-900">Pourquoi ENEOS HABITAT à La Réole</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8">Le marché immobilier à La Réole</h2>
          <div className="max-w-4xl prose prose-lg">
            <p className="text-muted-foreground leading-relaxed">
              La Réole est commune historique de Gironde, située dans confluence vallée Garonne-Dropt. Le marché immobilier réolois allie propriétés riveraines prestigieuses avec maisons de campagne, demeureurs vignobles.  Région viticole importante genère demande stable propriétés avec potentiel agritourisme ou oenologique. Les bâtiments anciens nombreux requièrent diagnostics amiante plomb rigoureux. Les enjeux énergétiques croissants imposent DPE précise. ENEOS HABITAT intervient régulièrement La Réole, maîtrisant enjeux immobiliers region viticole Garonne.
            </p>
          </div>
        </div>
      </section>
