...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.eneoshabitat.fr/diagnostic-immobilier-dax"
  }
}
...
export default function DaxPage() {
  return (
    <CityPageTemplate
      cityName="Dax"
      citySlug="dax"
      metaDescription="ENEOS HABITAT intervient à Dax pour tous vos diagnostics immobiliers obligatoires."
    />
  )
}
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">
              Diagnostic immobilier à <span className="text-emerald-600">Dax</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              ENEOS HABITAT, votre expert certifié pour tous vos diagnostics immobiliers à Dax et dans les Landes
            </p>
            <Link href="/devis">
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Nos services à Dax</h2>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8">Zone d'intervention à Dax</h2>
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              <MapPin className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-xl font-semibold mb-3">Dax et communes alentour</h3>
                <p className="text-foreground leading-relaxed">
                  ENEOS HABITAT intervient régulièrement à Dax, célèbre station thermale des Landes. Nous couvrons aussi les communes proches : Saint-Paul-lès-Dax, Seyresse, Narrosse, Benquet, Tarnos, Tercis-les-Bains, et bien d'autres.
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12">Pourquoi ENEOS HABITAT à Dax ?</h2>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-gradient-to-r from-emerald-600 to-emerald-700">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Vous avez un bien à diagnostiquer à Dax ?
          </h2>
