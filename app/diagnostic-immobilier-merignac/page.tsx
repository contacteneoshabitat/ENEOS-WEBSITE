  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white mb-6">
              ...
              <span className="text-sm font-medium">DIAGNOSTIC À MÉRIGNAC</span>
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Diagnostic immobilier à <span className="text-[#2d8a5e]">Mérignac</span>
            </h1>
            <p className="text-xl text-white/80 mb-8">
              ENEOS HABITAT réalise tous vos diagnostics immobiliers à Mérignac. Expertise, rapidité et certifications garanties pour vos transactions.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold mb-4">Nos services à Mérignac</h2>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl border border-gray-200">
              <p className="text-lg text-muted-foreground mb-4">
                ENEOS HABITAT intervient à <span className="font-semibold text-[#2d8a5e]">Mérignac</span> et dans toute la <span className="font-semibold text-[#2d8a5e]">Gironde</span>.
              </p>
              <p className="text-muted-foreground mb-4">
                Nous couvrons également les communes alentours comme Bordeaux, Pessac, Talence, Gradignan, Saint-Médard-en-Jalles et bien d&apos;autres communes de la métropole bordelaise.
              </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-12">Pourquoi ENEOS HABITAT à Mérignac</h2>
      ...
      <section className="py-16 bg-[#2d8a5e]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Besoin d&apos;un diagnostic à Mérignac ?
          </h2>
