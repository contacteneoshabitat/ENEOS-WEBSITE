...
export const metadata: Metadata = {
  title: "Diagnostic immobilier Périgueux | ENEOS HABITAT — Gironde",
  description: "ENEOS HABITAT intervient à Périgueux pour tous vos diagnostics immobiliers obligatoires. DPE, Amiante, Plomb, Électricité, Gaz. Intervention sous 48h. Devis gratuit en ligne.",
  alternates: {
    canonical: "https://www.eneoshabitat.fr/diagnostic-immobilier-perigueux"
  }
}

export default function PerigueuxPage() {
  return (
    <CityPageTemplate
      cityName="Périgueux"
      citySlug="perigueux"
      metaDescription="ENEOS HABITAT intervient à Périgueux pour tous vos diagnostics immobiliers obligatoires."
    />
  )
}
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">
              Diagnostic immobilier à <span className="text-emerald-600">Périgueux</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              ENEOS HABITAT, votre expert certifié pour tous vos diagnostics immobiliers à Périgueux et en Dordogne
            </p>
            <Link href="/devis">
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Nos services à Périgueux</h2>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-8">Zone d'intervention à Périgueux</h2>
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              <MapPin className="w-6 h-6 text-emerald-600 flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-xl font-semibold mb-3">Périgueux et alentours</h3>
                <p className="text-foreground leading-relaxed">
                  ENEOS HABITAT intervient régulièrement à Périgueux, la capitale du Périgord. Nous couvrons aussi les communes proches : Boulazac Isle Manoire, Trelissac, Marsac-en-Périgord, Chamiers, Sorges-et-Ligueux-en-Périgord, Saint-Laurent-sur-Manoire, et bien d'autres.
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-foreground leading-relaxed">
                  Basés en Gironde à Cadaujac, nous intervenons aussi en Dordogne pour vous offrir une couverture large. Nos diagnostiqueurs sont certifiés et reconnus pour leur expertise sur tout le territoire.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12">Pourquoi ENEOS HABITAT à Périgueux ?</h2>
      ...
      <section className="py-16 px-4 md:px-6 lg:px-8 bg-gradient-to-r from-emerald-600 to-emerald-700">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Vous avez un bien à diagnostiquer à Périgueux ?
          </h2>
