...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.eneoshabitat.fr/diagnostic-immobilier-bayonne"
  }
}

export default function BayonnePage() {
  return (
    <CityPageTemplate
      cityName="Bayonne"
      citySlug="bayonne"
      metaDescription="ENEOS HABITAT intervient à Bayonne pour tous vos diagnostics immobiliers obligatoires."
    />
  )
}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white mb-6">
              ...
              <span className="text-sm font-medium">DIAGNOSTIC À BAYONNE</span>
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Diagnostic immobilier à <span className="text-[#2d8a5e]">Bayonne</span>
            </h1>
            <p className="text-xl text-white/80 mb-8">
              ENEOS HABITAT réalise tous vos diagnostics immobiliers à Bayonne. Expertise, rapidité et certifications garanties pour vos transactions.
            </p>
      ...
      <div className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold mb-8 text-gray-900">Zone d'intervention à Bayonne</h2>
          
          <p className="text-gray-700 mb-6 leading-relaxed">
            ENEOS HABITAT intervient à Bayonne et dans les communes alentour : Anglet, Biarritz, Bidart, Hendaye, Saint-Jean-de-Luz et tous les secteurs des Pyrénées-Atlantiques.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Disponibilité sous 48h pour tous vos diagnostics immobiliers à Bayonne.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <p className="text-sm text-gray-600">
                Diagnostics immobiliers à Bayonne au meilleur prix, sans frais cachés.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-20">
        <div className="container mx-auto px-4 max-w-3xl">
          <h2 className="text-3xl font-bold mb-8 text-gray-900">Pourquoi ENEOS HABITAT à Bayonne</h2>
